...
var stripe = Stripe('pk_test_a1jO0CUSqdXrXS247IAvwzB800yCaNJh3p');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkouy form+ charge the credit card
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  (0, _stripe.bookTour)(tourID.tourId);
});
